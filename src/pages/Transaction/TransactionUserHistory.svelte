<script lang="ts">
    import TransactionUserHistoryTable from "components/TransactionHistory/TransactionUserHistoryTable.svelte";
    ...
    const handleGetList = async (setPage?: number) => {
        ...
        const response = await got("/transaction/user/history", "POST", params);
...
<div class="content">
    ...
    <Table tableTitle={transactionTableTitle}>
        <TransactionUserHistoryTable {tableList} {currentPage} {limit} />
    </Table>
