<script lang="ts">
    import HistoryAdminTransactionTable from "components/History/HistoryAdminTransactionTable.svelte";
    ...
    const handleGetList = async (setPage?: number) => {
        ...
        const response = await got("/history/money/admin", "POST", params);
...
<div class="content">
    ...
    <Table tableTitle={historyTableTitle}>
        <HistoryAdminTransactionTable {tableList} {currentPage} {limit} />
    </Table>
