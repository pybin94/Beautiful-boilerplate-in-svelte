<script lang="ts">
    import HistorySiteTransactionTable from "components/History/HistorySiteTransactionTable.svelte";
    ...
    const handleGetList = async (setPage?: number) => {
        ...
        const response = await got("/history/money/site", "POST", params);
...
<div class="content">
    ...
    <Table tableTitle={historyTableTitle}>
        <HistorySiteTransactionTable {tableList} {currentPage} {limit} />
    </Table>
