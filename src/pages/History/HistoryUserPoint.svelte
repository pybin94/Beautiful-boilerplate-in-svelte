<script lang="ts">
    import HistoryUserPointTable from "components/History/HistoryUserPointTable.svelte";
    ...
    const handleGetList = async (setPage?: number) => {
        ...
        const response = await got("/history/point/user", "POST", params);
...
<div class="content">
    ...
    <Table tableTitle={historyTableTitle}>
        <HistoryUserPointTable {tableList} {currentPage} {limit} />
    </Table>
