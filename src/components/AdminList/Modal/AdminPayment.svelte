<script lang="ts">
    ...
    let currency: string = adminInfo["balance"]
...
<form on:submit|preventDefault={handelPayment}>
    <div class="form-body">
        ...
        <div class="set-amount">
            <button type="button" class="medium line" on:click={()=>{setAmount(10000)}}>1만</button>
            <button type="button" class="medium line" on:click={()=>{setAmount(50000)}}>5만</button>
            <button type="button" class="medium line" on:click={()=>{setAmount(100000)}}>10만</button>
            <button type="button" class="medium line" on:click={()=>{setAmount(500000)}}>50만</button>
            <button type="button" class="medium line" on:click={()=>{setAmount(1000000)}}>100만</button>
            <button type="button" class="medium line" on:click={()=>{setAmount(5000000)}}>500만</button>
            <button type="button" class="medium red line" on:click={()=>{amount = undefined}}>리셋</button>
        </div>
